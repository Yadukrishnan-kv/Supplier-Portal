...
const navigate = useNavigate()
  ...
  return (
    <aside className="suppliersidebar">
      {/* Header */}
      <div className="suppliersidebar-header">
        <div className="suppliersidebar-logo-container">
          ...
          <span className="suppliersidebar-logo-text">VRISTO</span>
        </div>
          ...
          <nav className="suppliersidebar-nav-section">
            ...
            <div className="suppliersidebar-menu-item suppliersidebar-dropdown-item">
              ...
              <ul className={`suppliersidebar-submenu ${activeDropdown === "viewRFQ" ? "show" : ""}`}>
                <li>
                  <Link to="/listalltenders" className="suppliersidebar-submenu-link">
                    View all RFQ/RFP
                  </Link>
                </li>
                <li>
                  <Link to="/pendingTender" className="suppliersidebar-submenu-link">
                    Pending Review
                  </Link>
                </li>
                <li>
                  <Link to="/approvedTender" className="suppliersidebar-submenu-link">
                    Approved RFQ/RFP
                  </Link>
                </li>
                <li>
                  <Link to="/rejectTender" className="suppliersidebar-submenu-link">
                    Rejected RFQ/RFP
                  </Link>
                </li>
              </ul>
    ...
    <span className="suppliersidebar-menu-text">Company Profile</span>
            ...
            <div className="suppliersidebar-menu-item suppliersidebar-dropdown-item">
              ...
              <ul className={`suppliersidebar-submenu ${activeDropdown === "settings" ? "show" : ""}`}>
                <li>
                  <Link to="/changePassword" className="suppliersidebar-submenu-link">
                    Change Password
                  </Link>
                </li>
              </ul>
